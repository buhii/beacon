...
numPlayer = 4
"""
tune  = "5---5--56-6-6-2-3-4-3-2-3-4-3-2-"  #  1- 4
tune += "5---5--53-3-4-5-2---3---4---2---"  #  5- 8
tune += "5---5--56-6-6-2-3-4-3-2-3-4-3-2-"  #  9- 12
tune += "0---------1-2-3-3---2-2---------"  #  13- 16
tune += "33-33-33-33-3---33-33-33-33-3---"  #  17- 20
"""
tune  = "4---4--46-6-6-2-3-4-3-2-3-4-3-2-"  #  1- 4
tune += "4---4--43-3-4-5-2---3---4---2---"  #  5- 8
tune += "4---4--46-6-6-2-3-4-3-2-3-4-3-2-"  #  9- 12
tune += "0---------1-2-3-3---2-2---------"  #  13- 16
tune += "33-33-33-33-3---33-33-33-33-3---"  #  17- 20
...
#for ww in range(3):
#    drawTune(200,200, ww, 0, len(tune))
whoo = 1
for i in range(ww):
    for j in range(hh):
